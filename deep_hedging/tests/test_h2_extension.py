#!/usr/bin/env python
"""
Smoke tests for the H2 grid extension (Phase 9.5).
...
# -----------------------------------------------------------------------
# Test 5: Phase 9 loader returns expected cells
# -----------------------------------------------------------------------
...
def main() -> None:
    tests = [
        ...
        ("5. Phase 9 loader",                   test_prompt_9_loader),
