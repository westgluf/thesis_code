#!/usr/bin/env python
"""
Part A of Phase 12: worst-case adversarial perturbation via PGD.
...
Leverages the differentiable rBergomi simulator (Phase 1) — this
...
def main() -> None:
    ...
    print("\n  Loading baseline hedger from Phase 11 cache ...", flush=True)
