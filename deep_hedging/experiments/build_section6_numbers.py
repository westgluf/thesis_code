...
Source JSONs (all must exist on disk):
    figures/unified_baseline_results.json      (Phase 02)
    figures/decomposition_closed.json           (Phase 03)
    figures/diagnostic_controls_results.json    (Phase 03)
    figures/h_sweep_results.json                (Phase 05)
    figures/h2_grid_extension.json              (Phase 04)
