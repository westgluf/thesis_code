"""
Shared training convenience wrappers for Phase 9 (Pareto front).
...
Phase 3 (refactored in Phase 7 for the generic hedger interface).
"""
...
def train_deep_hedger_with_objective(
    ...
    *,
    ...
    introduced in Phase 7). The only thing that changes between calls is
